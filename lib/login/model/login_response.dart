class LoginResponse {
  ...
  LoginResponse.fromJson(Map<String, dynamic> json) {
    this.stores = json["stores"]==null ? null : (json["stores"] as List).map((e)=>Stores.fromJson(e)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    if(this.stores != null)
      data["stores"] = this.stores?.map((e)=>e.toJson()).toList();
...
class Stores {
  ...
  Stores({this.storeId, this.storeCode, this.storeName, this.address, this.dcId, this.dcName, this.accountId, this.accountName, this.subchannelId, this.subchannelName, this.channelId, this.channelName, this.areaId, this.areaName, this.regionId, this.regionName, this.latitude, this.longitude});
